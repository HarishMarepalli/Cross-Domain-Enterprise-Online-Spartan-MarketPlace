...
<head>
    ...
    <title>West Indies | Globetrotter</title>
</head>
    ...
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/2_caribbean.jpeg" alt="1_caribbean" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/3_caribbean.jpeg" alt="2_caribbean" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/1_caribbean.jpeg" alt="3_caribbean" class="d-block" style="width:100%">
            </div>
            </div>
