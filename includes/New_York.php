...
<head>
    ...
    <title>New York | Globetrotter</title>
</head>
<body class="newYorkPage">
    <?php $page='NewYork'; include 'navbar.php' ?>
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/NewYork1.jpeg" alt="NewYork1" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/NewYork2.jpeg" alt="NewYork2" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/NewYork3.jpeg" alt="NewYork3" class="d-block" style="width:100%">
            </div>
            </div>
