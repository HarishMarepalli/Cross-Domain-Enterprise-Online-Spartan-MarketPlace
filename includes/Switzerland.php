...
<head>
    ...
    <title> Switzerland | Globetrotter</title>
</head>
<body class="switzerlandPage">
    <?php $page='Switzerland'; include 'navbar.php' ?>
    <?php
        if(isset($_SESSION["isSecure"]))
        {
            if($_SESSION["isSecure"])
            {
                ...
                echo "<script>alert(".$custvisited.");</script>";
    ...
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/Switzerland1.jpeg" alt="Switzerland1" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/Switzerland2.jpeg" alt="Switzerland2" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/Switzerland3.jpeg" alt="Switzerland3" class="d-block" style="width:100%">
            </div>
            </div>
