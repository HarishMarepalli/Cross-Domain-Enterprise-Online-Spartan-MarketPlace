...
<head>
    ...
    <title>Tokyo | GTS Tours</title>
</head>
<body class="tokyoPage">
    <?php $page='Tokyo'; include 'navbar.php' ?>
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/2_tokyo.jpeg" alt="2_tokyo" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/3_tokyo.jpeg" alt="3_tokyo" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/1_tokyo.jpeg" alt="1_tokyo" class="d-block" style="width:100%">
            </div>
            </div>
        ...
        <div class="longDescContainer">
            ...
            <p class="longDesc">
            Tokyo officially the Tokyo Metropolis , is the capital and largest city of Japan. Formerly known as Edo, its metropolitan area (13,452 square kilometers or 5,194 square miles) is the most populous in the world, with an estimated 37.468 million residents as of 2018; the city proper has a population of 13.99 million people. Located at the head of Tokyo Bay, the prefecture forms part of the Kantō region on the central coast of Honshu, Japan's largest island.
            <br>
            <br>
