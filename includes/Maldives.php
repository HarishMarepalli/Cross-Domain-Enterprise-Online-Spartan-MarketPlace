...
<head>
    ...
    <title>Maldives | Globetrotter</title>
</head>
<body class="maldivesPage">
    <?php $page='Maldives'; include 'navbar.php' ?>
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/Maldives1.jpg" alt="Maldives1" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/Maldives2.jpg" alt="Maldives2" class="d-block" style="width:100%">
            </div>
            <div class="carousel-item">
                <img src="../img/Maldives3.jpeg" alt="Maldives3" class="d-block" style="width:100%">
            </div>
            </div>
